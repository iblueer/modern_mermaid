...
[![ライブデモ](https://img.shields.io/badge/デモ-オンライン-brightgreen.svg)](https://modern-mermaid.live/)
...
[![ライセンス](https://img.shields.io/badge/ライセンス-MIT-blue.svg)](LICENSE)
...
### メインインターフェース
![メインインターフェース](docs/images/screenshot-main.png)
<!-- 👆 メインインターフェースのスクリーンショットを追加してください -->

### テーマギャラリー
![テーマ](docs/images/screenshot-themes.png)
<!-- 👆 テーマ表示のスクリーンショットを追加してください -->

### 注釈ツール
![注釈](docs/images/screenshot-annotations.png)
<!-- 👆 注釈ツールのスクリーンショットを追加してください -->

### エクスポートオプション
![エクスポート](docs/images/screenshot-export.png)
<!-- 👆 エクスポートオプションのスクリーンショットを追加してください -->
